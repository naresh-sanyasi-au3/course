...
//   db.collection('students').updateOne({_id: require('mongodb').ObjectID(req.body.id)},
//   {$pull: 
//     { "language": req.body.remove
//   },
//     $push: 
//      {"language": req.body.add
//   }
// }, 
//     function(err, result) {
//     if(err)
...
//       res.json(result);
//   });
  db.collection('students').updateOne({_id: require('mongodb').ObjectID(req.body.id)}, {$pull: {language: req.body.remove}}, 
    function(err, result) {
      if(err)
        throw err;
      console.log(result);
    ...
    db.collection('students').updateOne({_id: require('mongodb').ObjectID(req.body.id)}, {$push: {language: req.body.add}}, 
    function(err, result) {
      if(err)
        throw err;
      res.json(result);
